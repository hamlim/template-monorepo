...
let SelectRoot: typeof SelectPrimitive.Root = SelectPrimitive.Root;

let SelectGroup: typeof SelectPrimitive.Group = SelectPrimitive.Group;

let SelectValue: typeof SelectPrimitive.Value = SelectPrimitive.Value;
